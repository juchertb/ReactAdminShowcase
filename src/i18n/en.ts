...
const customEnglishMessages: TranslationMessages = {
    ...
    pos: {
        ...
        dashboard: {
            ...
            welcome: {
                title: 'Welcome to the react-admin demo',
                subtitle:
                    "This Single Page Application showcases the react-admin framework and is powered by Vite and TypeScript. Feel free to explore and modify the data - it's local to your computer, and will reset each time you reload.",
    ...
    resources: {
        ...
        todos: {
            ...
            notifications: {
                created: 'Todo created |||| %{smart_count} todos created',
                updated: 'Todo updated |||| %{smart_count} todos updated',
                deleted: 'Todo deleted |||| %{smart_count} todos deleted',
            },
        },
        comments: {
        ...
        posts: {
            name: 'Post |||| Posts',
            amount: '1 review |||| %{smart_count} posts',
            relative_to_poster: 'Post on poster',
            detail: 'Post detail',
            fields: {
                postId: 'Id',
                title: 'Post title',
            ...
            notifications: {
                ...
                approved_success: 'Post approved',
                approved_error: 'Error: Post not approved',
                rejected_success: 'Post rejected',
                rejected_error: 'Error: Post not rejected',
            },
        },
        segments: {
